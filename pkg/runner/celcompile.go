		...
		cel.Declarations(
			...
			decls.NewFunction("randomLowercase",
				decls.NewOverload("randomLowercase_int",
					...
					decls.String)),
			// upload helpers
			decls.NewFunction("jspDelete",
				decls.NewOverload("jspDelete_string",
					[]*exprpb.Type{decls.String},
					decls.String)),
			decls.NewFunction("phpDelete",
				decls.NewOverload("phpDelete_string",
					[]*exprpb.Type{decls.String},
					decls.String)),
			decls.NewFunction("aspxDelete",
				decls.NewOverload("aspxDelete_string",
					[]*exprpb.Type{decls.String},
					decls.String)),
			decls.NewFunction("aspDelete",
				decls.NewOverload("aspDelete_string",
					[]*exprpb.Type{decls.String},
					decls.String)),
			// regex
