import{p as y,S as p,o as f,U as x,f as w,c as g,d as T,e as v,j as l,V as S,D as E,W as q,F as _}from"../chunks/DP9-rN22.js";const C=`# Afrog POC 规则编写权威指南
...
`;var P=w('<div class="flex flex-1 flex-col"><div class="markdown max-w-none"></div></div>');function O(d,u){y(u,!1);function c(n){return n.toLowerCase().trim().replace(/\s+/g,"-").replace(/[^a-z0-9\u4e00-\u9fa5-]/g,"")}p.use({renderer:{heading(n){const e=n?.text??"",s=n&&typeof n=="object"&&"depth"in n?Number(n.depth??1):1,o=c(e);return`<h${s} id="${o}" aria-level="${s}">${e}</h${s}>`}}});const m=p.parse(C);let r=S();f(()=>{const n=l(r);n&&(n.innerHTML=String(m||""),n.addEventListener("click",e=>{const o=e.target.closest('a[href^="#"]');if(!o)return;e.preventDefault();const b=o.getAttribute("href")||"",a=decodeURIComponent(b.slice(1)),i=n.querySelector(`#${CSS.escape(a)}`);i&&(i.scrollIntoView({behavior:"smooth",block:"start"}),history.replaceState(null,"",`#${a}`))}))}),x();var t=P(),h=E(t);g(h,n=>q(r,n),()=>l(r)),_(t),T(d,t),v()}export{O as component};
