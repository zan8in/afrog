import{p as w,W as l,o as g,X as T,f as v,Y as S,c as E,d as _,e as q,j as d,Z as C,P as u,Q as c,_ as P}from"../chunks/DV-hihCm.js";const O=`# Afrog POC 规则编写权威指南
...
`;var L=v('<div class="flex flex-1 flex-col"><div class="markdown max-w-none"><!></div></div>');function D(m,h){w(h,!1);function b(n){return n.toLowerCase().trim().replace(/\s+/g,"-").replace(/[^a-z0-9\u4e00-\u9fa5\-]/g,"")}l.use({renderer:{heading(n){const e=n?.text??"",s=n?.depth??1,o=b(e);return`<h${s} id="${o}" aria-level="${s}">${e}</h${s}>`}}});const y=l.parse(O);let r=C();g(()=>{const n=d(r);n&&n.addEventListener("click",e=>{const o=e.target.closest('a[href^="#"]');if(!o)return;e.preventDefault();const x=o.getAttribute("href")||"",i=decodeURIComponent(x.slice(1)),p=n.querySelector(`#${CSS.escape(i)}`);p&&(p.scrollIntoView({behavior:"smooth",block:"start"}),history.replaceState(null,"",`#${i}`))})}),T();var t=L(),a=u(t),f=u(a);S(f,()=>y),c(a),E(a,n=>P(r,n),()=>d(r)),c(t),_(m,t),q()}export{D as component};
