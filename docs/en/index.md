...
If you want the shortest path from setup to a working scan, start here:
...
If you want to build custom rules, start with:
...
If you want to embed `afrog` into your Go program, start with:
