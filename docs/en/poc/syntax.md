...
If you have not written your first PoC yet, start with [PoC Quickstart](./quickstart.md). If you are already editing rules, this page is the better tab to keep open.
...
- first working PoC: [PoC Quickstart](./quickstart.md)
- exact field syntax: this page
- helper or matching functions: [Helper Functions](./helper-functions.md)
