...
如果你还没有写出第一条 PoC，先看 [PoC 编写快速开始](./01-quickstart.md)；如果你已经开始写规则，这页更适合常驻开着查。
...
- 想先跑通第一条：看 [PoC 编写快速开始](./01-quickstart.md)
- 想确认字段怎么写：看本页
- 想确认函数怎么用：看 [内置函数参考](./03-helper-functions.md)
...
> **← 上一篇：** [PoC 编写快速开始](./01-quickstart.md) ｜ **下一篇 →：** [内置函数参考](./03-helper-functions.md)
